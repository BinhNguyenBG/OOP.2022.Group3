...
public class DCGUI {
	...
	public void draw(Graphics g) {
		if (circuit instanceof SerialCircuit) {
            ...
            g2d.drawLine(50+((250*seed-150)/2)+26, 400, 50+((250*seed-150)/2)+26+36, 400);
            g2d.drawLine(50+((250*seed-150)/2)+26+18, 400-18, 50+((250*seed-150)/2)+26+18, 400+18);
            g2d.drawLine(50+((250*seed-150)/2)+26+36+26, 400, 50+((250*seed-150)/2)+26+36+26+36, 400);
            
          //Draw String:
            g2d.setFont(new Font("Arial", Font.BOLD,30));
    		g2d.drawString((int)dc.getVoltage() + " " + dc.getVolunit(),50+((250*seed-150)/2)+40,330); 
